...
## [1.5.2](https://github.com/joo-chang/better-chatbot/compare/v1.24.0...v1.5.2) (2025-10-07)
...
* add Discord badge and section to README for community engagement ([4d2f165](https://github.com/joo-chang/better-chatbot/commit/4d2f16501a0144fd8431dc246aad89dc9c51f204))
...
* add open router ([a391ce4](https://github.com/joo-chang/better-chatbot/commit/a391ce418dcffe5c7bbdd803ef3f4b80bcb0cd73))
...
* change CMD to use shell form for sequential commands (pnpm db:migrate && pnpm start) in Dockerfile ([bfc6585](https://github.com/joo-chang/better-chatbot/commit/bfc6585cecfbd62fc867a79f038b3e69a3567bbe))
...
* docker postgres not finsihed ([d49f275](https://github.com/joo-chang/better-chatbot/commit/d49f27509f57921daf5491a556cf79abca048e88))
